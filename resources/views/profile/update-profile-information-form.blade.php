            ...
            <div class="grid gap-6 lg:grid-cols-[16rem_minmax(0,1fr)]" x-data="{photoName: null, photoPreview: null}">
                <div>
                    ...
                    <div class="mt-2" x-show="! photoPreview">
                        <img src="{{ $this->user->profile_photo_url }}" alt="{{ $this->user->name }}" class="h-36 w-36 rounded-2xl object-cover ring-2 ring-blue-100 shadow-xl shadow-blue-600/20 dark:ring-blue-900">
                    </div>
                ...
                <div class="space-y-5">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <x-input-error for="year_level" class="mt-2" />
                        </div>
                    </div>
