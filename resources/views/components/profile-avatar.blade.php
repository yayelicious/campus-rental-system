...
@if ($showChevron)
    <div class="inline-flex items-center gap-1 rounded-full bg-gradient-to-r from-blue-600 to-violet-600 p-1 pr-2 shadow-lg shadow-blue-600/25 {{ $class }}">
        <div class="{{ $sizeClass }} rounded-full overflow-hidden bg-white ring-1 ring-white/90">
        ...
        <span class="pointer-events-none inline-flex h-5 w-5 items-center justify-center rounded-full bg-violet-700 text-white transition group-hover:bg-violet-600 dark:bg-violet-600 dark:group-hover:bg-violet-500">
