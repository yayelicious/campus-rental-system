...
<?php endif; ?>
                ...
                <div class="mt-2" x-show="! photoPreview">
                    <img src="<?php echo e($this->user->profile_photo_url); ?>" alt="<?php echo e($this->user->name); ?>" class="h-32 w-32 rounded-2xl object-cover ring-2 ring-blue-100 shadow-xl shadow-blue-600/20 dark:ring-blue-900">
                </div>

                <!-- New Profile Photo Preview -->
                <div class="mt-2" x-show="photoPreview" style="display: none;">
                    <span class="block h-32 w-32 rounded-2xl bg-cover bg-no-repeat bg-center ring-2 ring-blue-100 shadow-xl shadow-blue-600/20 dark:ring-blue-900"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['class' => 'me-2 mt-3','type' => 'button','xOn:click.prevent' => '$refs.photo.click()']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'me-2 mt-3','type' => 'button','x-on:click.prevent' => '$refs.photo.click()']); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\sub\resources\views/profile/update-profile-information-form.blade.php ENDPATH**/ ?>